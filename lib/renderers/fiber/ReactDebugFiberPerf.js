...
if (__DEV__) {
  ...
  ReactDebugFiberPerf = {
    ...
    stopWorkLoopTimer() {
      ...
      const warning = commitCountInCurrentWorkLoop > 1 ? 'There were cascading updates' : null;
      commitCountInCurrentWorkLoop = 0;
